...
public class UserDataLoader implements CommandLineRunner {
    ...
    private void loadUserData() {
        if(userRepository.count() == 0) {
            ...
            BookEntity book1 = new BookEntity("My first book.", "Book book", "Jeremias Catalixo", "1995-03-23", "Matarato LTDA");
            bookRepository.save(book1);
            BookEntity book2 = new BookEntity("My second book.", "Book book 2", "Guilhonizo Ribostovski","1995-03-23", "Tibetian Editor");
